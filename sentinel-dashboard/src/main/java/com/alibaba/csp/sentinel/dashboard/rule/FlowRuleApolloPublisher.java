...
public class FlowRuleApolloPublisher implements DynamicRulePublisher<List<FlowRuleEntity>> {
    ...
    public void publish(String app, List<FlowRuleEntity> rules) throws Exception {
        ...
        apolloOpenApiClient.createOrUpdateItem(appId, System.getProperty("apollo.env"), System.getProperty("apollo.cluster"), System.getProperty("apollo.namespace"), openItemDTO);
        ...
        apolloOpenApiClient.publishNamespace(appId, System.getProperty("apollo.env"), System.getProperty("apollo.cluster"), System.getProperty("apollo.namespace"), namespaceReleaseDTO);
    }
}
